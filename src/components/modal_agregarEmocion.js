  ...
  const handleInputChange = (e) => {
    ...
    return (
        ...
        <div className="btnRegistro" onClick={handleShow}>
            <Button><i className="bi bi-plus-lg btn2-pregunta" variant="success" onClick={handleShow}>Agregar emocion</i></Button>
        </div>
        ...
        <div className="sumbitRegistro">
                    ...
                    <h2>¡Genial, nueva emocion!</h2>
                        ...
                        <Link to="/preguntas"><button type='button' onClick={handleClose} className='btn btn_submit'>Agregar</button></Link>
